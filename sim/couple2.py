"""openEMS: two adjacent transmit elements at the half-wave pitch.
...
e2 = (Element(cfg, mirror=True,
              dip_trim_mirror=float(DTM) if DTM else None)
      if MIRROR else Element(cfg))
...
if __name__ == "__main__":
    ...
    json.dump(out, open(os.path.join(RESULTS, f"c2_{tag}.json"), "w"))
